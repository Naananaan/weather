...
const description_span = document.querySelector('#description'); // Corrected variable name
const icon_img = document.querySelector('img');
const url = 'https://api.openweathermap.org/data/2.5/weather?';
const icon_url = 'http://openweathermap.org/img/wn/';
const api_key = '821aa44875f3a24ca7c045b6018ddd4f';
...
const getLocation = () => {
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(position => {
            ...
            // Once the geolocation is obtained, fetch weather data based on the coordinates
